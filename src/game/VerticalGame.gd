class_name VerticalGame extends Node
...
func get_field_px_size() -> int:
	return $VBoxContainer/MiddleAreaControl/AspectRatioContainer/FieldControl.rect_size.x
...
func _set_background() -> void:
	...
	for c in _background_cells:
		$VBoxContainer/MiddleAreaControl/AspectRatioContainer/FieldControl.add_child(c)
...
func _set_walls() -> void:
	...
	for wp in _stage_description.get_walls_points():
		...
		$VBoxContainer/MiddleAreaControl/AspectRatioContainer/FieldControl.add_child(wall)
...
func _setup_snake() -> void:
	...
	$VBoxContainer/MiddleAreaControl/AspectRatioContainer/FieldControl.add_child(_snake)
		...
		for ir in _stage_description.get_instantaneous_edible_rules():
			if _can_spawn(ir, _edibles):
				...
				if instance != null: # is is possible that no compatible free cell is found
					...
					$VBoxContainer/MiddleAreaControl/AspectRatioContainer/FieldControl.add_child(instance)
...
func _update_hud() -> void:
	...
	$VBoxContainer/TopAreaControl/InfoLabel.text = score_text + "    " + time_text
	var effects: String = ""
	...
	$VBoxContainer/TopAreaControl/EffectsLabel.text = effects
